...
module.exports = {
    ...
    ========================================*/
    RequestYoudao: function (type, word) {
        if (type === void 0) { type = 0; }
        return __awaiter(this, void 0, void 0, function () {
            var requestString, _a, body, headers, writeRootPath, countryID, firstLetter, wordPath, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        requestString = "http://dict.youdao.com/dictvoice?type=" + type + "&audio=" + word;
                        console.log(requestString);
                        return [4 /*yield*/, request(requestString)];
                    case 1:
