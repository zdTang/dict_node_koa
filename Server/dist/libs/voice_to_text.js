...
module.exports = {
    voiceToText: function (voice) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.main(voice).catch(console.error)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    },
    main: function (voicePath) {
        return __awaiter(this, void 0, void 0, function () {
            var speech, fs, client, fileName, file, audioBytes, audio, config, request, response, transcription;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
