        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        result = "";
                        return [4 /*yield*/, db.query("call GetWord(?)", [word])];
                    case 1:
                        result = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        word = undefined;
                        return [4 /*yield*/, db.query("Select * from Class")];
                    case 1:
                        word = _a.sent();
