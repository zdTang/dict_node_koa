...
var VoiceToText = require(Path.resolve(__dirname, '../libs/voice_to_text'));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                mYword = ctx.query.word;
                return [4 /*yield*/, DAL.GetWord(mYword)];
            case 1:
                result = _a.sent();
                ctx.body = result;
                return [2 /*return*/];
...
router.post('/textToVoice', function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var word, firstLetter, pathToVoice, readDir, nameList, result, respondVoicePath, thisResult;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
